...
export const siteData = {
  ...
  about: {
    ...
    content: [
      ...
      "After graduation, I headed back to New York to start a Web Design internship with The RMM Group, a small NYC-based entertainment company. That experience made me open the door to the creative aspect of tech, and before long, software engineering and web design were drawing me. As my experience increased, I secured a role as web developer with Mednet Technologies in Long Island, NY—a crucial step to transforming my hobby into a career.",
      "Throughout my career, I have been associated with over 10 companies from start up to large corporations. Every role had its share of challenges, but I have always been determined and utilized skills to solve problem professionally.",
